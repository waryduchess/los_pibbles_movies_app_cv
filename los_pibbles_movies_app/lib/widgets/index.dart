...
export 'buttons/biometric_auth_button.dart';
export 'buttons/button_widget.dart';
export 'ui_elements/gradient_background_widget.dart';
export 'ui_elements/input_widget.dart';
export 'buttons/logout_button_widget.dart';
export 'ui_elements/text_widget.dart';

// Widgets movidos desde presentation/widgets/
export 'comments/add_comment_sheet.dart';
export 'buttons/animated_favorite_button.dart';
export 'ui_elements/category_selector.dart';
export 'comments/comment_section.dart';
export 'movies/featured_movie_card.dart';
