      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: LinearProgressIndicator(value: strengthValue, color: strengthColor, backgroundColor: colors.surfaceContainerHighest)),
                const SizedBox(width: 8),
                Text(strengthText, style: TextStyle(color: strengthColor, fontSize: 12, fontWeight: FontWeight.bold)),
              ],
            ),
