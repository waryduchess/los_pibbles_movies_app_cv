...
class _ChangeNameScreenState extends State<ChangeNameScreen> {
  ...
  Future<void> _submit() async {
    ...
    final apellidos = _apellidosCtrl.text.trim().replaceAll(RegExp(r'\s+'), ' ');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const AppH2(text: 'Actualizar Perfil', textAlign: TextAlign.center),
        centerTitle: true,
      ),
      body: Stack(
        children: [
